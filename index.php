...
<html lang="id">
  <head>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDrRsai5JQ4M46hU38XwgSfCuy0v_B0l_0&language=id&region=ID"></script>
    <script>
  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <?php else:?>            
            <li><a href="?m=tempat_list"><span class="glyphicon glyphicon-map-marker"></span> Peta Sebaran Tempat Wisata</a></li>
    ...
    <footer class="footer bg-primary">
      <div class="container">
        <p>Copyright &copy; <?=date('Y')?> Lisa Aprilianti <em class="pull-right">29 November 2021</em></p>
      </div>
    </footer>
</body>
</html>